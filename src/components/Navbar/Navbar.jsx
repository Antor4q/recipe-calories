...
const Navbar = () => {
    return (
        <div className="my-12 lg:w-full w-[350px]">
            ...
            <div className="navbar-start">
              ...
              <a className="btn btn-ghost text-2xl lg:text-[32px] pl-0 pr-0 font-bold">Recipe Calories</a>
            </div>
            ...
            <label className="hidden lg:inline-flex input input-bordered flex items-center gap-2 bg-[#150B2B0D] p-3 rounded-[50px] border-none">
